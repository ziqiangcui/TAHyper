...
def load_data(path, name='BlogCatalog',exp_id='0',original_X = False, extra_str=""):
    ...
    # path_here = path+name+extra_str+'/'+name+exp_id+'.mat'
    path_here = path+name+extra_str+'/'+name+exp_id+'.mat'

    data = sio.loadmat(path_here)
    print("using data is: ", path_here)
...
def load_data_v2(path, name='BlogCatalog',exp_id='0',original_X = False, extra_str=""):

    # path_here = path+name+extra_str+'/'+name+exp_id+'.mat'
    path_here = path+name+extra_str+'/'+name+exp_id+'ICnewT'+'.mat'
    ...
    return X, A, T, T_diff, Y1, Y0


def load_data_v3(path, name='BlogCatalog',exp_id='0',original_X = False, extra_str=""):


    data = sio.loadmat(path)
    print("using data is: ", path)
    A = data['Network'] #csr matrix
    ...
    return X, A, Y1, Y0, T_old, T_new, T_diff


def load_data_taiji(path, name='BlogCatalog',exp_id='0',original_X = False, extra_str=""):
